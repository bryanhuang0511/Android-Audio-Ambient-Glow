...
function Initialize()
	...
	SKIN:Bang("!Move", configX, configY + 152, "#CURRENTCONFIG#\\GradientWindow")
...
function selectPopup(var, options)
	...
	for i,o in ipairs(options) do
		...
		"LeftMouseDownAction",
		"[!SetVariable %var% %v% \"#*ROOTCONFIG*#\\SettingsWindow\"][!WriteKeyValue Variables %var% %v% \"" .. variablesFile .. "\"][!SetOption %var%_Select Text %name% \"#*ROOTCONFIG*#\\SettingsWindow\"][!DeactivateConfig]"
