...
### 📲 Android 手機端安裝
1. 前往 [`mobile/`](mobile/) 資料夾，下載 **[`手機音效氣氛燈.apk`](mobile/手機音效氣氛燈.apk)**。
...
| :---: | :---: | :---: |
| <img src="mobile/Screenshots/01_Settings_Control.jpg" width="260" /> | <img src="mobile/Screenshots/02_Portrait_AOD_Mode.jpg" width="260" /> | <img src="mobile/Screenshots/03_Landscape_Speaker_Mode.jpg" width="380" /> |
